...
cities <- list(
  "Chongqing" = "~/imperial/Reach of Last Mile/lade_delivery_cq_h3.csv",
  "Shanghai" = "~/imperial/Reach of Last Mile/lade_delivery_sh_h3.csv",
  "Hangzhou" = "~/imperial/Reach of Last Mile/lade_delivery_hz_h3.csv"
)
...
# --- Plot 1: All Three Cities Combined (Original Scale) ---
p_combined <- ggplot(express_partial, aes(x = distance, color = city, fill = city)) +
  ...
  scale_color_manual(values = c("Chongqing" = "#CC6677", "Shanghai" = "#117733", "Hangzhou" = "#332288")) +
  scale_fill_manual(values = c("Chongqing" = "#CC6677", "Shanghai" = "#117733", "Hangzhou" = "#332288")) +
  labs(
    title = "Partial Effect of Distance on Flow - LaDe",
    x = "Distance (km)",
    y = "Predicted Flow",
    color = "City",
    fill = "City"
...
saveRDS(express_partial_scaled_combined, "china_curves.rds")
...
p_combined_scaled <- ggplot(express_partial_scaled_combined, aes(x = distance, color = city, fill = city)) +
  ...
  labs(
    title = "Partial Effect of Distance on Flow - LaDe (Proportion of Total)",
    x = "Distance (km)",
